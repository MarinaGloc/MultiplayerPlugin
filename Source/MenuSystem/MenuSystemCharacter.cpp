...
AMenuSystemCharacter::AMenuSystemCharacter():
	...
	JoinSessionCompleteDelegate(FOnJoinSessionCompleteDelegate::CreateUObject(this, &ThisClass::OnJoinedSessionComplete))
{
...
void AMenuSystemCharacter::OnJoinedSessionComplete(FName SessionName, EOnJoinSessionCompleteResult::Type Result)
{
	if (!OnlineSessionInterface.IsValid())
	{
		return;
