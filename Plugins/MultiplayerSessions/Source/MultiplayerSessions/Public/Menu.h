...
public:
	...
	void MenuSetup(int32 NumberOfPublicConnections = 4, FString TypeOfMatch = FString(TEXT("Free for All")), FString LobbyPath = FString(TEXT("/Game/StarterContent/Maps/Lobby")));
